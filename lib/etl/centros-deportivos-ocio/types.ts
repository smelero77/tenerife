/**
 * Type definitions for CKAN Centros Deportivos y Ocio ETL pipeline
 */

/**
 * Raw CKAN DataStore record structure
 */
export interface RawCkanCentroRecord {
 ...
 * Bronze layer record
 */
export interface BronzeCentroRecord {
 ...
 */
export interface SilverCentroRecord {
  source_dataset_id: string;
  source_resource_id: string;
 ...
 */
export interface FactCentroRecord {
  ine_code: string;
  centro_tipo: string;
