...
import { RawCkanEmpresaServicioRecord, SilverEmpresaServicioRecord } from './types';
 ...
 * Format: "servicios informaticos", "servicios juridicos", etc.
 */
 ...
 */
export function transformEmpresaServicioRecord(
  rawRecord: RawCkanEmpresaServicioRecord,
  sourceDatasetId: string,
  sourceResourceId: string
): SilverEmpresaServicioRecord | null {
  // Required field
