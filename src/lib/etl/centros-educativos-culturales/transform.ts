...
import { RawCkanCentroEducativoCulturalRecord, SilverCentroEducativoCulturalRecord } from './types';
 ...
 * Format: "centro educativo", "biblioteca", "museo", "academia", etc.
 */
 ...
 */
export function transformCentroEducativoCulturalRecord(
  rawRecord: RawCkanCentroEducativoCulturalRecord,
  sourceDatasetId: string,
  sourceResourceId: string
): SilverCentroEducativoCulturalRecord | null {
  // Required field
