/**
 * Type definitions for CKAN Centros Médicos y Farmacias ETL pipeline
 */

/**
 * Raw CKAN DataStore record structure
 */
export interface RawCkanCentroMedicoFarmaciaRecord {
 ...
 * Bronze layer record
 */
export interface BronzeCentroMedicoFarmaciaRecord {
 ...
 */
export interface SilverCentroMedicoFarmaciaRecord {
  source_dataset_id: string;
  source_resource_id: string;
 ...
 */
export interface FactCentroMedicoFarmaciaRecord {
  ine_code: string;
