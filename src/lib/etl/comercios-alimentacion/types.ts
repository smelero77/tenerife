/**
 * Type definitions for CKAN Comercios de Alimentación ETL pipeline
 */

/**
 * Raw CKAN DataStore record structure
 */
export interface RawCkanComercioAlimentacionRecord {
 ...
 * Bronze layer record
 */
export interface BronzeComercioAlimentacionRecord {
 ...
 */
export interface SilverComercioAlimentacionRecord {
  source_dataset_id: string;
  source_resource_id: string;
 ...
 */
export interface FactComercioAlimentacionRecord {
  ine_code: string;
