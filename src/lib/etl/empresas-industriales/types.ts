/**
 * Type definitions for CKAN Empresas Industriales ETL pipeline
 */

/**
 * Raw CKAN DataStore record structure
 */
export interface RawCkanEmpresaIndustrialRecord {
 ...
 * Bronze layer record
 */
export interface BronzeEmpresaIndustrialRecord {
 ...
 */
export interface SilverEmpresaIndustrialRecord {
  source_dataset_id: string;
  source_resource_id: string;
 ...
 */
export interface FactEmpresaIndustrialRecord {
  ine_code: string;
  empresa_tipo: string;
